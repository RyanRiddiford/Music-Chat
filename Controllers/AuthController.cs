...
namespace music_chat.Controllers
{
    ...
    public class AuthController : Controller
    {
        ...
        public async Task<IActionResult> LoginRequest(string email, string password)
        {
            ...
            using(var response = Client.GetAsync(Client.BaseAddress + "api/Auth/" + email + "/" + password)) {



                dynamic data = JsonConvert.DeserializeObject<dynamic>(await response.Result.Content.ReadAsStringAsync());
 ...
 return View("Login");
            ...
            HttpContext.Session.SetString("account_id", (string)data.account_id);
            HttpContext.Session.SetString("image", (string)data.image);
